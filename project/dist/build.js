...
const cart = {
    ...
    template: `
                <li class="header__menu-title" >
                    <a class="header__link" href="#" type="button" @click="showCart = !showCart">
                        <svg class="header__icon" width="33" height="29"
                        viewBox="0 0 33 29"
                    ...
                    <div class="cart-block" v-show="showCart">
                        <cart-item v-for="item of cartItems" :key="item.id_product" :img="item.img" :cart-item="item" @remove="remove"></cart-item>
                    </div>
                </li>
              `
};
...
(() => {
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _CartComponent_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _ProductComponent_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
/* harmony import */ var _FilterComp_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3);
/* harmony import */ var _ErrorComp_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4);
...
const app = new Vue({
    ...
    components: {
        ...
        // 'filterEl': filterEl
        filterEl: _FilterComp_js__WEBPACK_IMPORTED_MODULE_2__["default"]
    },
    data: {
        userSearch: '',
    },
